...
- Lorsqu'OCR Mistral et un fournisseur IA sont configurés, le dépôt d'un justificatif photo/PDF propose automatiquement fournisseur, date, référence, catégorie et ventilation multi-TVA. L'utilisateur doit confirmer la proposition ; un écart avec le TTC bancaire bloque l'application et la saisie manuelle reste toujours disponible.
